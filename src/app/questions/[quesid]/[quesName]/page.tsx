...
const Page = async ({
  ...
  const avatarInitials = await avatars.getInitials(author.name, 36, 36);
  const attachmentBuffer = await storage.getFilePreview(questionAttachmentBucket, question.attachmentId);
    const attachmentBlob = new Blob([attachmentBuffer]);
    const attachmentUrl = URL.createObjectURL(attachmentBlob);
    
    const avatarUrl = URL.createObjectURL(new Blob([avatarInitials]));
    useEffect(() => {
        return () => {
            ...
            <div className="relative mx-auto px-4 pb-20 pt-36">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <picture>
                            <img
                                src={attachmentUrl} // Use the resolved URL here
                                alt={question.title}
                        ...
                        <div className="mt-4 flex items-center justify-end gap-1">
                            <picture>
                                <img
                                    src={avatarUrl} // Use the generated object URL here
                                    alt={author.name}
